            ...
            <div className="p-6 space-y-3">
              ...
              {wallets.map((wallet) => (
                <button
                  ...
                  className="w-full flex items-center space-x-4 p-4 bg-slate-700/50 hover:bg-slate-700 rounded-lg border border-slate-600 hover:border-slate-500 transition-all duration-200 group"
                >
            ...
            <div className="p-6 pt-0">
              <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                <p className="text-blue-400 text-sm">
                  ⚠️ Make sure you're connected to BSC Testnet network
                </p>
              </div>
            </div>
          </div>
